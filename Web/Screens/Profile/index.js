...
import { View, Text, TouchableOpacity, ScrollView, ActivityIndicator, Linking, Image } from 'react-native';
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.detailRow}>
          <FontAwesome name="envelope" size={20} color="#555" style={styles.detailIcon} />
          <Text style={styles.detailLabel}>Email:</Text>
          <Text style={styles.detailValue}>{userData?.email}</Text>
        </View>
        
        <View style={styles.detailRow}>
          <FontAwesome name="phone" size={20} color="#555" style={styles.detailIcon} />
        ...
        {userData?.license_expiration_date && (
          <View style={styles.detailRow}>
            <FontAwesome name="id-card" size={20} color="#555" style={styles.detailIcon} />
        ...
        <View style={styles.detailRow}>
          <FontAwesome name="calendar" size={20} color="#555" style={styles.detailIcon} />
      ...
      <View style={styles.documentsContainer}>
        ...
        {documents.length === 0 ? (
          <View style={styles.emptyDocuments}>
            <FontAwesome name="file-o" size={40} color="#CCC" />
