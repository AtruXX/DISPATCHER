...
export default function CreateTrailer() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log(token);
      const response = await fetch('https://atrux-717ecf8763ea.herokuapp.com/api/v0.1/trailers/', {
        method: 'POST',
        headers: {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.headerCard}>
          <Text style={styles.headerTitle}>Creare Remorca</Text>
          <Text style={styles.headerSubtitle}>
            Completati detaliile pentru o remorca noua
          </Text>
        </View>
        ...
        <View style={styles.formCard}>
          ...
          >
            <TouchableOpacity 
              ...
              activeOpacity={0.9}
            >
              <Text style={styles.submitButtonText}>CREEAZĂ REMORCA</Text>
            </TouchableOpacity>
          </LinearGradient>
        </View>
      </ScrollView>
